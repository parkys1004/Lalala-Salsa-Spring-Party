        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          >
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/10 aspect-[4/3]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex items-end p-8">
                <div>
                    <h3 className="text-3xl font-bold text-white mb-2">Raul & Yomi</h3>
                    <p className="text-pink-300 font-medium">Sensual Bachata Instructors</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-2 text-pink-400 mb-2">
                ...
                <span className="font-bold tracking-widest uppercase text-sm">Workshop Class</span>
            </div>
            ...
            <div className="space-y-4 py-4">
                <div className="flex items-start gap-4 p-4 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
                    <div className="bg-pink-500/20 p-2 rounded-full text-pink-400 mt-1">
                        <Users size={20} />
                    </div>
                    <div>
                        <h4 className="font-bold text-lg text-white">대상</h4>
                        <p className="text-gray-400">바차타 초·중급 이상 레벨</p>
                    </div>
                </div>
                
                <div className="flex items-start gap-4 p-4 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
                    <div className="bg-purple-500/20 p-2 rounded-full text-purple-400 mt-1">
                        <CheckCircle size={20} />
                    </div>
                    <div>
                        <h4 className="font-bold text-lg text-white">커리큘럼</h4>
                        <p className="text-gray-400">누구나 화려해지는 센바 패턴 & 스타일링</p>
                    </div>
                </div>
            </div>

            <div className="inline-block px-6 py-2 rounded-full bg-pink-900/40 border border-pink-500/50 text-pink-200 font-mono">
                ⏰ PM 8:00 ~ 9:00 (60min)
            </div>
          </motion.div>
